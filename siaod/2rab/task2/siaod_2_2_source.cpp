...
// 1 задание: Преобразование текстовых данных из txt_file в бинарный формат и запись в bin_file
...
// 2 задание: Преобразование данных из бинарного файла bin_file в текстовый формат и запись в txt_file
...
// 3 задание: Вывод данных из бинарного файла bin_file на консоль
...
// 4 задание: Получение записи из бинарного файла filename по заданной позиции
...
// 5 задание: Удаление записи с заданным ключом из бинарного файла bin_name
